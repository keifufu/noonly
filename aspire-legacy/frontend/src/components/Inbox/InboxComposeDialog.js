import { Button, Dialog, DialogActions, DialogContent, DialogTitle, LinearProgress, withStyles } from '@material-ui/core'
...
class InboxComposeDialog extends Component {
	render() {
		...
		return (
			...
			<DialogTitle style={{ cursor: 'move' }} id='draggable-title'>Compose Email</DialogTitle>
...
export default withStyles(styles, { withTheme: true })(withSnackbar(InboxComposeDialog))