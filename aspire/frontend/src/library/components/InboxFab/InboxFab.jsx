	...
	return (
		displayTrash
			? trigger
				...
				: <Fab text='Clear Trash' icon={DeleteForever} onClick={() => dispatch.dialog.open({ id: 8, payload: 'clear' })} />
			: trigger
				? <Fab text='Scroll to top' icon={ExpandLess} onClick={scrollBackUp} />
				: <Fab text='Compose' icon={Add} onClick={() => dispatch.dialog.open({ id: 21 })} />
	)
}
