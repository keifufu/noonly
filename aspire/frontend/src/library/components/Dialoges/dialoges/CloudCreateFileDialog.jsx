...
function CloudCreateFileDialog({ id, dialog, closeDialog, createFile }) {
...
const mapDispatch = (dispatch) => ({
	...
	createFile: dispatch.cloud.createFile
})
export default connect(mapState, mapDispatch)(CloudCreateFileDialog)