...
function PasswordNoteDialog({ id, dialog, closeDialog, setNote }) {
...
const mapDispatch = (dispatch) => ({
	...
	setNote: dispatch.passwords.setNote
})
export default connect(mapState, mapDispatch)(PasswordNoteDialog)