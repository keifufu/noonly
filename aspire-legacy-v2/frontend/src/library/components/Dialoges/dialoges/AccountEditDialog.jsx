...
function AccountEditDialog({ id, dialog, closeDialog, editAccount }) {
	...
	const validateForm = (values) => {
		...
		if (values.address.length > 128) errors.address = 'Email can\'t be longer than 128'
...
const mapDispatch = (dispatch) => ({
	...
	editAccount: dispatch.accounts.edit
})
export default connect(mapState, mapDispatch)(AccountEditDialog)